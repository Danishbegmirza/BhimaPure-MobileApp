...
export function ShopOnlineSuccessScreen({ navigation }: Props) {
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>
          Your redemption request has been submitted. After verification, your exclusive coupon code will be
          shared via email. Our representative may reach out for further support.
        </Text>
